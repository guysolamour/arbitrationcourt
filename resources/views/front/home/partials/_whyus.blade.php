    ...
    <div class="container-fluid" data-aos="fade-up">
      ...
      <div class="row">
        ...
        <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
          ...
          <div class="content">
            <h3>Pourquoi un centre d'arbitrage <strong>en ligne</strong></h3>
            <p>
        ...
        <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("/vendor/template/assets/img/why-us.png");' data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>
      </div>
